...
export const TEMPLATE_PACKS: Record<string, TemplatePackV1> = Object.fromEntries([
  ...
  pack({ service: "applepodcast", label: "Apple Podcasts", icon: "🎧", color: "#8e8e93", primaryEntities: ["episode", "podcast"], detailEntities: ["podcast", "episode", "author"], views: [["kpi", "收听概览"], ["gallery", "播客与单集", { entityType: "episode", limit: 60 }], ["heatmap", "收听热力图"], ["area", "节目时长趋势", { seriesKey: "monthly:durationMinutes" }], ["line", "收听进度趋势", { seriesKey: "monthly:progress" }], ["donut", "收听状态", { seriesKey: "category:status" }]] }),
  ...
  pack({ service: "weibo", label: "微博", icon: "🟠", color: "#ff8200", primaryEntities: ["weibo"], detailEntities: ["weibo", "status", "tag", "resources"], views: [["kpi", "微博概览"], ["gallery", "微博卡片", { entityType: "weibo", limit: 60 }], ["heatmap", "发布与收藏热力图"], ["bar", "互动指标", { seriesKeys: ["sum:likeCount", "sum:commentCount", "sum:shareCount"] }], ["donut", "来源分布", { seriesKey: "category:source" }]] }),
  ...
  pack({ service: "jike", label: "即刻", icon: "🟡", color: "#ffe411", primaryEntities: ["posts"], detailEntities: ["posts", "post", "tag", "resources"], views: [["kpi", "动态概览"], ["gallery", "动态卡片", { entityType: "posts", limit: 60 }], ["heatmap", "发布热力图"], ["bar", "互动指标", { seriesKeys: ["sum:likeCount", "sum:commentCount", "sum:shareCount"] }], ["donut", "动态类型", { seriesKey: "category:type" }]] }),
